...
class StrProxyTest extends TestCase
{
    /** @test */
    ...
    public function str_ascii(): void
    {
        ...
        $this->assertSame(
            ...
            (new StrProxy('х Х щ Щ ъ Ъ ь Ь'))->ascii('bg')->get()
        );
        $this->assertSame(
            Str::ascii('ä ö ü Ä Ö Ü', 'de'),
            (new StrProxy('ä ö ü Ä Ö Ü'))->ascii('de')->get()
        );
    }
    ...
    public function str_finish(): void
    {
        $this->assertSame(
            ...
            (new StrProxy('this/string'))->finish('/')->get()
        );
        $this->assertSame(
            Str::finish('this/string/', '/'),
            (new StrProxy('this/string/'))->finish('/')->get()
    ...
    public function str_length(): void
    {
        ...
        $this->assertSame(
            Str::length('foo bar baz', 'UTF-8'),
            (new StrProxy('foo bar baz'))->length('UTF-8')
        );
    }
